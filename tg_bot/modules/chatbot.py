...
from tg_bot import OWNER_ID, dispatcher,AI_API_KEY 
...
__help__ = f"""
Marie's AI based Chatbot feature allows Marie to talk and provides a more interactive group chat experience.
